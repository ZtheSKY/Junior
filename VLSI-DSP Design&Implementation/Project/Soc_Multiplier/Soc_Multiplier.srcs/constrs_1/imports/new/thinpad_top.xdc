#Clock
set_property -dict {PACKAGE_PIN K21 IOSTANDARD LVCMOS33} [get_ports clk_main] ;#main clock in
...
create_clock -period 5.000 -name clk_200M -waveform {0.000 2.500} [get_ports clk_main]

# Algorithm_2 booth radix-4
#create_clock -period 9.000 -name clk_111M111 -waveform {0.000 4.500} [get_ports clk_main]
